...
YEAR = 2020
taxitype= "green"
BASE_URL = f"https://github.com/DataTalksClub/nyc-tlc-data/releases/download/{taxitype}/{taxitype}_tripdata_{YEAR}-"
...
def download_file(month):
    ...
    file_path = os.path.join(DOWNLOAD_DIR, f"{taxitype}_tripdata_{YEAR}-{month}.csv.gz")
